...
class PrivateIngredientAPITest(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=user2, name='Kala')
    ...
    def test_filter_ingredients_assigned_to_ingredients(self):
        """Test listing ingredients by those assigned to recipes."""
        in1 = Ingredient.objects.create(user=self.user, name='Applies')
